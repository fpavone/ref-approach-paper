...
\begin{reply}
\fede{Thank you for the feedback. We renovated Section 1 and Section 2, improving the paper according to your suggestions.}
\end{reply}
...
\begin{reply}
\fede{We added a new Section 3.3 which summarises and elaborate the results of Section 3.}
\end{reply}
