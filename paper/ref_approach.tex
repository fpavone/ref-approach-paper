...
\fede{Clearly, the reference model approach require a sensible model. The construcion of such a model should follow proper modelling workflow including model assessment and validation \citep[see, e.g.][]{gelman2020bayesian}. Better predictive models imply better selection results.}
