...
%  \hline
Data  & Method & RMSE Full & RMSE Sel & \# Sel (CPL, AVG, SD) & \# Sel noisy (CPL, AVG, SD) \\ 
  \hline
body fat & projpred & 4.36 & 4.45 & (2, 2.3, 0.48) &   \\
& steplm & 4.38 & 4.46 & (7, 6, 0.94) &  \\
\hline
+ noisy variables & projpred & 4.48 & 4.46 & (2, 2, 0)&  (0, 0, 0)  \\
& steplm & 5.74 & 5.13 & (23, 26.2, 4.54) & (15, 18.9, 4.01) \\
%   \hline
\end{tabular}
\caption{Predictive performances with original body fat data (first two
  ...
  CPL = results for the complete data (not using cross-validation).
  AVG = average over the 10-fold cross-validation. SD = standard deviation
...
\item steplm (without a reference model): Stepwise selection using AIC as in the body fat example.
