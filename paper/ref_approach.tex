...
\begin{itemize}
\item to show a simple and basic way to frame any variable selection method in the reference model approach,
\item to do a structured comparison for variable selection methods using or not a reference model, both for the the complete and the minimal subset selection,
\item to bring evidence in supporting the projection predictive approach as a principled way to use the reference model.
\end{itemize}
