...
perform variable selection, it is known that variance is
generally more harmful then bias \citep{piironen2017comparison}.}

\fede{In general, there is not restriction on the type of model the reference models 
...
models. \fede{As an example, Table \ref{tab:computational_time} reports
...
\begin{table}[tp]
	...
	\begin{tabular}{l|cc|ccc}
		...
		\hline
		body fat & 37.661 & 15.289 & 52.95 &  &  \\
		  &  & 0.078 &  & 0.078 &  \\
		  & 37.661 & 0.078 &  &  & 37.739 \\
		\hline 
		+ noisy variables & 169.797 & 77.638 & 247.435 &  &  \\
		  & & 12.019 & & 12.019 & \\
		  & 169.797 & 12.019 & & & 181.816
		
	\end{tabular}
	\caption{Computational time (in seconds) of body fat example of Section \ref{bodyfat-1}.
		The reported time is the sum of the time to fit the reference model (second column) and
		to explore the search path (third column), according to the method.}
