...
\begin{itemize}
\item add original contribution that are:
\item motivation and example on how the use of a reference model improves the selection (projpred example)
\item a comparison between using a reference model or not in the normal means problem  both with simulated data and the bodyfat data
\end{itemize}
...
\begin{itemize}
\item details about hyperparameters of the methods used
\end{itemize}
