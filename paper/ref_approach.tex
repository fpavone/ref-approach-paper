...
averaged after 100 data simulations. Use of a reference model reduces RMSE of the selected model for all the methods. projpred has superior FDR and the
smallest RMSE. Using a reference model improves also FDR of steplm significantly. Stepwise
